...
<!-- Fetched: 2026-08-13 16:45:35 UTC -->
...
- 
- 
- File input methods | Gemini API | Google AI for Developers
...
- Grant Service Agent access to each bucket
...
- Grant the Gemini API Service Agent permissions to read your storage
buckets.
...
- Browse to the [Service Account console](https://console.cloud.google.com/iam-admin/serviceaccounts)

- Select the relevant service account

- Select the Keys tab and choose Add key, Create new key

- Choose the JSON key type, and note where the file was downloaded to on
your machine.
