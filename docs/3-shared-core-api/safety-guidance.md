...
<!-- Fetched: 2026-08-13 16:45:39 UTC -->
...
- 
- 
- Safety and factuality guidance | Gemini API | Google AI for Developers
...
Note: LLMs are known to sometimes produce different outputs for the
