...
<!-- Fetched: 2026-08-13 16:45:26 UTC -->
...
Structured Outputs
Formatting the final response. Use when you want the model's answer in a specific format.

Function Calling
Taking action during conversation. Use when the model needs to ask you to perform a task before providing a final answer.
