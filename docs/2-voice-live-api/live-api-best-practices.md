...
<!-- Fetched: 2026-08-13 16:45:04 UTC -->
...
- 
- 
- Live API best practices | Gemini API | Google AI for Developers
...
- Specify the agent persona: Provide detail on the agent's name, role, and
...
- Specify the conversational rules: Put these rules in the order you expect
...
- Specify tool calls within a flow in distinct sentences: For example, if a
...
- Add any necessary guardrails: Provide any general conversational
