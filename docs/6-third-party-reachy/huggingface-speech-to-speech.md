...
<!-- Fetched: 2026-08-13 16:26:58 UTC -->
...
GitHub - huggingface/speech-to-speech: Build local voice agents with open-source models · GitHub
...
[](/)[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhuggingface%2Fspeech-to-speech)Appearance settings
...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fhuggingface%2Fspeech-to-speech)
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=huggingface%2Fspeech-to-speech)Appearance settings
...
Notifications
](/login?return_to=%2Fhuggingface%2Fspeech-to-speech) You must be signed in to change notification settings
...
Fork
1.5k
](/login?return_to=%2Fhuggingface%2Fspeech-to-speech)
...
](/huggingface/speech-to-speech/issues)
...
](/huggingface/speech-to-speech/pulls)
...
](/huggingface/speech-to-speech/actions)
...
](/huggingface/speech-to-speech/projects)
...
](/huggingface/speech-to-speech/security)
...
](/huggingface/speech-to-speech/pulse)
...
[Branches](/huggingface/speech-to-speech/branches)[Tags](/huggingface/speech-to-speech/tags)
[](/huggingface/speech-to-speech/branches)[](/huggingface/speech-to-speech/tags)
...
## History
[903 Commits](/huggingface/speech-to-speech/commits/main/)
[](/huggingface/speech-to-speech/commits/main/)903 Commits

[.github](/huggingface/speech-to-speech/tree/main/.github)
...
[archive](/huggingface/speech-to-speech/tree/main/archive)
...
[assets](/huggingface/speech-to-speech/tree/main/assets)
...
[demo](/huggingface/speech-to-speech/tree/main/demo)
...
[docs/assets](/huggingface/speech-to-speech/tree/main/docs/assets)
...
[examples](/huggingface/speech-to-speech/tree/main/examples)
...
[scripts](/huggingface/speech-to-speech/tree/main/scripts)
...
[src/speech_to_speech](/huggingface/speech-to-speech/tree/main/src/speech_to_speech)
...
[tests](/huggingface/speech-to-speech/tree/main/tests)
...
[.DS_Store](/huggingface/speech-to-speech/blob/main/.DS_Store)
...
[.dockerignore](/huggingface/speech-to-speech/blob/main/.dockerignore)
...
[.gitignore](/huggingface/speech-to-speech/blob/main/.gitignore)
...
[AGENTS.md](/huggingface/speech-to-speech/blob/main/AGENTS.md)
...
[Dockerfile](/huggingface/speech-to-speech/blob/main/Dockerfile)
...
[Dockerfile.arm64](/huggingface/speech-to-speech/blob/main/Dockerfile.arm64)
...
[LICENSE](/huggingface/speech-to-speech/blob/main/LICENSE)
...
[MANIFEST.in](/huggingface/speech-to-speech/blob/main/MANIFEST.in)
...
[README.md](/huggingface/speech-to-speech/blob/main/README.md)
...
[docker-compose.yml](/huggingface/speech-to-speech/blob/main/docker-compose.yml)
...
[logo.png](/huggingface/speech-to-speech/blob/main/logo.png)
...
[mypy.ini](/huggingface/speech-to-speech/blob/main/mypy.ini)
...
[pyproject.toml](/huggingface/speech-to-speech/blob/main/pyproject.toml)
...
[](https://raw.githubusercontent.com/huggingface/speech-to-speech/main/logo.png)
...
[](https://pypi.org/project/speech-to-speech/)
[](/huggingface/speech-to-speech/blob/main/LICENSE)
...
- Voice Activity Detection (VAD): [Silero VAD v5](https://github.com/snakers4/silero-vad) detects speech boundaries and turn-taking.
...
Deprecated implementations, including MeloTTS, live in [`archive/`](/huggingface/speech-to-speech/blob/main/archive) and are no longer wired into the CLI.
...
STT
[Parakeet TDT](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3) (default)
CUDA / CPU through nano-parakeet, Apple Silicon through MLX
built-in

STT
[Whisper](https://huggingface.co/docs/transformers/en/model_doc/whisper) through Transformers
CUDA / CPU
built-in
...
STT
[MLX Audio Whisper](https://github.com/huggingface/mlx-audio)
Apple Silicon
built-in on macOS
...
LLM
[Transformers](https://huggingface.co/models?pipeline_tag=text-generation&sort=trending)
CUDA / CPU
built-in
...
TTS
[Qwen3-TTS](https://huggingface.co/Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice) (default)
...
`kokoro` on non-macOS; built-in on macOS
...
`serve`
Runs the pipeline server over OpenAI Realtime WebSocket and WebRTC.
You are building an app or device against the API.

`talk --url <full-realtime-url>`
Runs the packaged microphone/speaker client.
You want to talk to an existing Realtime server.

`local`
Composes `serve` and `talk` in-process over loopback.
You want to run the server and talk to it from one command.
...
The packaged client can opt in to local Python tools with `talk --tool-module <module>` or `local --tool-module <module>`. The module contract, programmatic API, and a Serper web-search example are documented in [Tool calling design](/huggingface/speech-to-speech/blob/main/src/speech_to_speech/api/openai_realtime/README.md#packaged-python-client-tools).
...
For a fully local native-audio setup with the browser demo, Realtime turn revisions, and barge-in, see the tested [Gemma 4 12B speech-to-speech example for Apple Silicon](/huggingface/speech-to-speech/blob/main/examples/gemma4-12b-macos/README.md).
...
TTS
Qwen3-TTS (default)
Multilingual, with `--qwen3_tts_language auto` by default
...
References for pipeline CLI arguments live in the [arguments classes](/huggingface/speech-to-speech/blob/main/src/speech_to_speech/arguments_classes) and in `speech-to-speech serve -h`. Client arguments are listed by `speech-to-speech talk -h`.

### Module-Level Parameters
[](#module-level-parameters)

See [ModuleArguments](/huggingface/speech-to-speech/blob/main/src/speech_to_speech/arguments_classes/module_arguments.py). It allows setting:
...
See [VADHandlerArguments](/huggingface/speech-to-speech/blob/main/src/speech_to_speech/arguments_classes/vad_arguments.py). Notable options:
...
Citations for optional backends such as Kokoro, Pocket TTS, ChatTTS, Whisper variants, Paraformer, and MMS live in the respective [component READMEs](/huggingface/speech-to-speech/blob/main/src/speech_to_speech).

## About
Build local voice agents with open-source models

### Topics
[ai](/topics/ai)[assistant](/topics/assistant)[language-model](/topics/language-model)[machine-learning](/topics/machine-learning)[python](/topics/python)[speech](/topics/speech)[speech-synthesis](/topics/speech-synthesis)[speech-to-text](/topics/speech-to-text)[speech-translation](/topics/speech-translation)

### Resources
[Readme](#readme-ov-file)
[Apache-2.0 license](#Apache-2.0-1-ov-file)
[Activity](/huggingface/speech-to-speech/activity)
[Custom properties](/huggingface/speech-to-speech/custom-properties)
...
### Forks
[1.5k forks](/huggingface/speech-to-speech/forks)
[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fhuggingface%2Fspeech-to-speech&report=huggingface+%28user%29)
