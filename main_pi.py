...
DEFAULT_SYSTEM_INSTRUCTION = (
    ...
    "to Arabic, switch back to Arabic.\n"
    "- Never mix the two in one sentence. Any other language: answer "
    "in Arabic.\n"
    "- Arabic style: plain Modern Standard Arabic (فصحى), spoken "
    "naturally -- no regional accent and no dialect words. Keep it "
    "warm and conversational, not stiff or formal like a newsreader; "
    "simple, correct, everyday MSA that any Arabic speaker "
    "understands.\n"
    "\n"
    "STYLE\n"
